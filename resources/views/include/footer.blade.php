        ...
        <div class="row ">
            <div class="col-md-4">
                <div class="contact-details">
                    ...
                    <ul class="contact">
                        <li><p><i class="fal fa-map-marker"></i> <strong>نشانی: </strong>تبریز، 35 کیلومتری جاده آذرشهر، دانشگاه شهید مدنی آذربایجان</p></li>
                        <li><p><i class="fal fa-phone"></i> <strong>تلفن: </strong>44444444 </p></li>
                        <li><p><i class="fal fa-envelope"></i> <strong>کد پستی: </strong>444444 </p></li>
                    </ul>
                </div>
            </div>
