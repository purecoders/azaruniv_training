                    ...
                    <div class="card-body row">
                        ...
                        <div class="col-xl-8">
                            <div class="tab-card-title mx-2 d-flex flex-column justify-content-between">
                                ...
                                @if($course->cost == 0)
                                    <a href="{{route('course.show', ['id'=>$course->id])}}" class="course-price align-self-start mt-1">رایگان</a>
                                @else
                                    <a href="{{route('course.show', ['id'=>$course->id])}}" class="course-price align-self-start mt-1">{{number_format($course->cost)}} تومان </a>
                                @endif
